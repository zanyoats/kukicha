...
def job_kind_label(kind: str) -> str:
    labels = {
        ...
        "edit_album_musicbrainz": "Metadata URL",
...
def humanize_job_context_key(key: str) -> str:
    labels = {
        ...
        "roots_added": "Added Roots",
        "roots_removed": "Removed Roots",
        "roots_scanned": "Roots",
        ...
        "remote_objects_updated": "Remote Objects",
        "local_folders_pruned": "Folders Removed",
...
def format_job_context_value(key: str, value: object) -> str:
    compact_count_keys = {
        ...
        "local_files_updated",
        "remote_objects_updated",
        "local_folders_pruned",
